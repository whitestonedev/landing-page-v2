...
export const markdownComponents = {
  ...
  h4: ({ node, ...props }) => <h4 className="text-xl font-semibold my-4" {...props} />,
  h5: ({ node, ...props }) => <h5 className="text-lg font-semibold my-3" {...props} />,
  h6: ({ node, ...props }) => <h6 className="text-base font-semibold my-3" {...props} />,
  p: ({ node, ...props }) => <p className="my-4 text-muted-foreground leading-relaxed" {...props} />,
  a: ({ node, ...props }) => (
    <a
  ...
  pre: ({ node, ...props }) => (
    <pre className="bg-muted p-4 rounded-lg overflow-x-auto my-4 border-none" {...props} />
  ),
  ...
  img: ({ node, ...props }) => (
    <img className="my-4 rounded-md shadow-md max-w-full h-auto" {...props} loading="lazy" />
  ),
  table: ({ node, ...props }) => (
